...
const Content$4 = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center pl-3 lg:pl-24">
      <div className="grid grid-cols-2 gap-5 sm:grid-cols-2  mt-[40px] w-[98%] text-balance lg:flex ">
